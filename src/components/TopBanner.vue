  ...
  <div class="top-banner clearfix">
      <div class="site-category" >
          <div class="top-side-left">
              <ul class="side-left">
                  <li class="side-item clearfix"
				      @mouseleave="sideLeave()"
                      @mouseenter="sideEnter(item.type)"
                      v-for="item in sideItems" :key="item.type">
                     <span class="cont">{{item.content}}</span> 
                      <span class="fai"><i class="fa fa-angle-right"></i></span>
                  </li>
              </ul>
          </div>
      </div>
	  ...
	  @mouseenter="sideEnter()" @mouseleave="sideLeave()" >
		  <ul class="category-items" v-for="goods in currGoods" :key="goods.id">
			  <li class="category-goods" >
				  <a class="goods-link" :href="goods.sourceUrl">
					  <img :src="goods.imgUrl" alt="">
					  <div class="text-name">{{goods.name}}</div>
				  </a>
				  <a :href="goods.buyUrl" v-show="goods.buyStatus" >选购</a>
			  </li>
		  </ul>
	  </div>
