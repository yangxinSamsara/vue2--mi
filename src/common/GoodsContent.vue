  ...
  <div class="goods-content">
      ...
      <div class="box-bd">
          <ul class="content-list clearfix">
              <li v-for="content in contents" :key="content.type">
                  <goods-content-list :content="content"></goods-content-list >
              </li>
          </ul>
      </div>
  </div>
...
import GoodsContentList from './GoodsContentList'
export default {
  data() {
    return {
      currPage: 0,
      ...
      contents: [
        ...
        },
        {
          ...
          list: [
            {
              sourceUrl:
                "http://zhuti.xiaomi.com/detail/4ecf4ebb-7cba-4142-96aa-6b8deb2426ef",
              title: "新世纪福音战士OL",
              desc: "EVA手游正版授权，同名主题，高能来袭！",
              price: "免费",
              imgUrl:
                "http://i3.mifile.cn/a4/7d47dde1-60fb-4ff3-8fa1-364cfc452457",
              type: 1
            },
            {
              sourceUrl:
                "http://zhuti.xiaomi.com/detail/d6277519-ca46-420c-ab09-060f6d293f94",
              title: "世界就在这里",
              desc: "“青春的世界里，每一刻都要用尽全力欢呼”",
              price: "免费",
              imgUrl:
                "http://i3.mifile.cn/a4/b2c8ca37-4ba8-4af8-b87e-91847980a278",
              type: 1
            },
            {
              sourceUrl:
                "http://zhuti.xiaomi.com/detail/13df18d4-e52c-4a61-82e3-97014f21bd77",
              title: "不悔剑三",
              desc: "精品剑网三同人主题 浪漫武侠 共闯天涯",
              price: "3米币",
              imgUrl:
                "http://i3.mifile.cn/a4/10af68f9-3012-48bb-85b1-ad3b0646dfdb",
              type: 1
            },
            {
          ...
          list: [
            {
              ...
              price: "免费",
              imgUrl:
                "http://i3.mifile.cn/a4/6032cb36-587f-4366-89ef-aefed2546552",
              type: 1
            },
            {
            ...
            {
              sourceUrl:
                "http://game.xiaomi.com/app-appdetail--app_id__581412.html",
              title: "剑侠情缘",
              desc: "玩剑侠情缘手游，领666壕礼！！",
              price: "免费",
              imgUrl:
                "http://i3.mifile.cn/a4/010948ae-bd48-49c6-af12-4ec8c4a0c829",
              type: 1
            },
            {
  ...
  components: {
    ...
    "goods-content-list":GoodsContentList
  }
};
</script>
