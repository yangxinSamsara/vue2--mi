<template>
  <div class="goods-match">
    <div class="match-top clearfix">
      <h3>{{topTitle}}</h3>
      <ul class="top-sub">
          <li v-for="sub in subs" :key="sub.key"
    ...
    <div class="match-content clearfix">
      <match-left :left-goods="leftGoods"></match-left>
      <match-right :curr-goods="currGoods"></match-right>
    </div>
  </div>
</template>
<script>
      ...
      hotGoods: [
        {
          ...
          imgUrl:
            "//i2.mifile.cn/a1/T12HJvByEv1RXrhCrK.jpg?width=150&height=150",
        ...
        },
        {
          ...
          imgUrl:
            "//i2.mifile.cn/a1/T1eSZgBjVT1RXrhCrK.jpg?width=150&height=150",
        ...
        },
        {
          ...
          imgUrl:
            "//i2.mifile.cn/a1/T1ycK_BjYv1RXrhCrK.jpg?width=150&height=150",
          title: "小米圈铁耳机",
          price: "99",
          heat: "1.4万",
          reviewDesc: "比我以前买的小米充电宝砖头好太多了！放在包里不占位置...",
        ...
        },
        {
          ...
          imgUrl:
            "//i2.mifile.cn/a1/pms_1463579883.27084326.jpg?width=150&height=150",
          title: "小米插线板",
          price: "49",
          heat: "24.7万",
          reviewDesc: "比我以前买的小米充电宝砖头好太多了！放在包里不占位置...",
        ...
        },
        {
          ...
          imgUrl:
            "//i2.mifile.cn/a1/T190DvB4dv1RXrhCrK.jpg?width=150&height=150",
          title: "小米蓝牙耳机",
          price: "79",
          oldPrice: "8.8",
          heat: "2万",
        ...
        },
        {
          ...
          imgUrl:
            "//i2.mifile.cn/a1/T1WxYvB_xv1RXrhCrK.jpg?width=150&height=150",
          title: "小米活塞耳机 基础版",
          price: "29",
          heat: "5.5万",
          reviewDesc: "比我以前买的小米充电宝砖头好太多了！放在包里不占位置...",
        ...
        },
        {
          ...
          imgUrl:
            "//i2.mifile.cn/a1/T1F5K_BjVv1RXrhCrK.jpg?width=150&height=150",
          title: "小米小钢炮蓝牙音箱2",
          price: "129",
          heat: "1.2万",
          reviewDesc: "比我以前买的小米充电宝砖头好太多了！放在包里不占位置...",
